(function () {
  ...
  // import "./css/common/ui/Checkbox.css";
  // import "./css/common/ui/Input.css";
  // import "./css/common/ui/Placeholder.css";
  // import "./css/common/ui/Radio.css";
  // import "./css/common/ui/Select.css";
  // import "./css/common/ui/Tab.css";
  // import "./js/common/ui/Select";
  // import "./js/common/ui/Tab";
  ...
  var CronGenComponent = /*#__PURE__*/function () {
    ...
    _createClass(CronGenComponent, [{
      ...
      value: function setActiveTab($event) {
        var targetTab = $event.target.dataset.target;
  ...
  var SPRING_OLD_REGEX = /^\s*($|\w+\s*=|(\?|\*|(?:[0-5]?\d)(?:(?:-|\/|\,)(?:[0-5]?\d))?(?:,(?:[0-5]?\d)(?:(?:-|\/|\,)(?:[0-5]?\d))?)*)\s+(\?|\*|(?:[0-5]?\d)(?:(?:-|\/|\,)(?:[0-5]?\d))?(?:,(?:[0-5]?\d)(?:(?:-|\/|\,)(?:[0-5]?\d))?)*)\s+(\?|\*|(?:[01]?\d|2[0-3])(?:(?:-|\/|\,)(?:[01]?\d|2[0-3]))?(?:,(?:[01]?\d|2[0-3])(?:(?:-|\/|\,)(?:[01]?\d|2[0-3]))?)*)\s+(\?|\*|(?:0?[1-9]|[12]\d|3[01])(?:(?:-|\/|\,)(?:0?[1-9]|[12]\d|3[01]))?(?:,(?:0?[1-9]|[12]\d|3[01])(?:(?:-|\/|\,)(?:0?[1-9]|[12]\d|3[01]))?)*)\s+(\?|\*|(?:[1-9]|1[012])(?:(?:-|\/|\,)(?:[1-9]|1[012]))?(?:,(?:[1-9]|1[012])(?:(?:-|\/|\,)(?:[1-9]|1[012]))?)*|\?|\*|(?:JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC)(?:(?:-)(?:JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC))?(?:,(?:JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC)(?:(?:-)(?:JAN|FEB|MAR|APR|MAY|JUN|JUL|AUG|SEP|OCT|NOV|DEC))?)*)\s+(\?|\*|(?:[1-7]|MON|TUE|WED|THU|FRI|SAT|SUN)(?:(?:-|\/|\,)(?:[1-5]))?(?:,(?:[1-7]|MON|TUE|WED|THU|FRI|SAT|SUN)(?:(?:-|\/|\,)(?:[1-5]))?)*|\?|\*|(?:MON|TUE|WED|THU|FRI|SAT|SUN)(?:(?:-)(?:MON|TUE|WED|THU|FRI|SAT|SUN))?(?:,(?:MON|TUE|WED|THU|FRI|SAT|SUN)(?:(?:-)(?:MON|TUE|WED|THU|FRI|SAT|SUN))?)*)(|\s)+)$/;
    ...
    _createClass(CronGenService, [{
      ...
      value: function isValid(cronFormat, expression) {
        ...
        switch (cronFormat) {
          ...
          case 'spring_old':
            return !!formattedExpression.match(SPRING_OLD_REGEX);
      ...
      value: function selectOptions() {
        return {
          ...
          monthDaysWithLasts: _toConsumableArray(new Array(31)).map(function (val, idx) {
            return "".concat(idx + 1);
          })
        };
      }
  ...
  var CronGenTimeSelect = /*#__PURE__*/function () {
    CronGenTimeSelect.$inject = ["$scope", "cronGenService"];

    /*@ngInject*/
    function CronGenTimeSelect($scope, cronGenService) {
      var _this = this;
    ...
    _createClass(CronGenTimeSelect, [{
      key: "ampmDisplay",
      value: function ampmDisplay(ampm) {
  ...
  angular.module('angular-cron-gen', []).service('cronGenService', CronGenService).component('cronGenTimeSelect', {
    ...
    templateUrl:
    /*@ngInject*/
    ["$attrs", function templateUrl($attrs) {
